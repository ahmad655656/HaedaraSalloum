// components/process/ProcessSection.jsx
"use client";

import React from 'react';
import { motion } from "framer-motion";
import ProcessHeader from '../process/ProcessHeader';
import ProcessStepsGrid from '../process/ProcessStepsGrid';
import ProcessFooter from '../process/ProcessFooter';

const ProcessSection = () => {
  return (
    <section id="process" className="relative py-20 md:py-24 bg-light-bg-primary dark:bg-dark-bg-primary overflow-hidden">
      {/* خلفية متدرجة */}
