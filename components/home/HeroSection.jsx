...
export default function HeroSection() {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center overflow-hidden bg-light-bg-primary dark:bg-dark-bg-primary"
    >
      {/* خلفية متدرجة */}
      ...
      <div className="container mx-auto px-4 xl:px-0 pt-20 xl:pt-24 flex flex-col xl:flex-row items-center justify-between gap-16">
        ...
        >
          ...
          >
            ...
            , crafting clean, performant interfaces with React, Next.js, and a
            touch of elegance.
          </motion.p>
      ...
      >
        <div className="flex flex-col items-center gap-2">
          <span className="text-xs uppercase tracking-[0.25em] font-medium text-light-text-tertiary dark:text-dark-text-tertiary">
            Scroll
          </span>
          <motion.div
